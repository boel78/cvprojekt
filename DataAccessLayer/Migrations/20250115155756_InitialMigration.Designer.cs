...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20250115155756_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.CvView", b =>
                {
                    b.Property<int>("Cvid")
                        .HasColumnType("int")
                        .HasColumnName("CVID");
            ...
            modelBuilder.Entity("UserProjects", b =>
                {
                    ...
                    b.HasKey("UserId", "ProjectId")
                        .HasName("PK__UserProj__9B23A0DCC327D1ED");
            ...
            modelBuilder.Entity("Models.Cv", b =>
                {
                    b.HasOne("Models.User", "OwnerNavigation")
                        .WithMany("Cvs")
                        .HasForeignKey("Owner")
            ...
            modelBuilder.Entity("Models.CvView", b =>
                {
                    b.HasOne("Models.Cv", "Cv")
                        .WithOne("CvView")
                        .HasForeignKey("Models.CvView", "Cvid")
                        .IsRequired()
